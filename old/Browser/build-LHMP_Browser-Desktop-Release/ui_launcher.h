...
"padding-left: 2px;"));
    ...
    void retranslateUi(QMainWindow *Launcher)
    {
        ...
        ___qtablewidgetitem7->setText(QApplication::translate("Launcher", "Password", 0));
        ...
        ___qtablewidgetitem8->setText(QApplication::translate("Launcher", "Item", 0));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_2->horizontalHeaderItem(1);
        ___qtablewidgetitem9->setText(QApplication::translate("Launcher", "Value", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        pushButton_7->setToolTip(QApplication::translate("Launcher", "<html><head/><body><p>Settings</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
