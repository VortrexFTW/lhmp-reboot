...
enum LHMPNetChannels
{
	LHMP_NETCHAN_MAIN,
	LHMP_NETCHAN_FOOTSYNC,
	LHMP_NETCHAN_VEHSYNC,
	LHMP_NETCHAN_SHOOT,
	LHMP_NETCHAN_VEHICLESHOOT,
	LHMP_NETCHAN_CHAT,
	LHMP_NETCHAN_VEHPROP,
	LHMP_NETCHAN_PLAYERPROP,
	LHMP_NETCHAN_STATECHANGE,
};
